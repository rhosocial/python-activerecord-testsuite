...
"""
Python 3.12+ fixture model definitions for mixins tests.
...
class TimestampedPost(IntegerPKMixin, TimestampMixin, ActiveRecord):
    ...
    def save(self, **kwargs) -> Self:
        """Save the post and return self for chaining."""
        super().save(**kwargs)
        return self
...
class VersionedProduct(IntegerPKMixin, OptimisticLockMixin, ActiveRecord):
    ...
    @override
    def save(self, **kwargs) -> Self:
        """Save the product and return self for chaining."""
        super().save(**kwargs)
        return self
...
class Task(IntegerPKMixin, SoftDeleteMixin, ActiveRecord):
    ...
    @override
    def save(self, **kwargs) -> Self:
        """Save the task and return self for chaining."""
        super().save(**kwargs)
        return self
...
class CombinedArticle(IntegerPKMixin, TimestampMixin, OptimisticLockMixin, SoftDeleteMixin, ActiveRecord):
    ...
    @override
    def save(self, **kwargs) -> Self:
        """Save the article and return self for chaining."""
        super().save(**kwargs)
        return self
