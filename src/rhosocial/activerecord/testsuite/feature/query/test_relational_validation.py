...
def test_with_method_invalid_paths():
...
def test_with_method_invalid_paths_leading_dot():
...
def test_with_method_invalid_paths_trailing_dot():
...
def test_with_method_invalid_paths_consecutive_dots():
...
def test_with_method_relation_not_found():
...
def test_process_relation_path_validation():
...
def test_process_relation_path_invalid_format():
...
def test_update_existing_relation_config():
