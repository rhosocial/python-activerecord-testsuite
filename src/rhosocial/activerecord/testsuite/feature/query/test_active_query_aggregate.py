...
class TestAsyncActiveQueryAggregate:
    ...
    @pytest.mark.asyncio
    async def test_count_simple_async(self, async_order_fixtures):
        """
    ...
    @pytest.mark.asyncio
    async def test_count_with_column_async(self, async_order_fixtures):
        """
    ...
    @pytest.mark.asyncio
    async def test_count_distinct_async(self, async_order_fixtures):
        """
    ...
    @pytest.mark.asyncio
    async def test_sum_simple_async(self, async_order_fixtures):
        """
    ...
    @pytest.mark.asyncio
    async def test_sum_with_column_async(self, async_order_fixtures):
        """
    ...
    @pytest.mark.asyncio
    async def test_avg_simple_async(self, async_order_fixtures):
        """
    ...
    @pytest.mark.asyncio
    async def test_min_max_simple_async(self, async_order_fixtures):
        """
    ...
    @pytest.mark.asyncio
    async def test_exists_method_async(self, async_order_fixtures):
        """
    ...
    @pytest.mark.asyncio
    async def test_aggregate_with_where_condition_async(self, async_order_fixtures):
        """
