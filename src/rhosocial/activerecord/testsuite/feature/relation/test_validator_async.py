# src/rhosocial/activerecord/testsuite/feature/relation/test_validator_async.py
"""
...
detection via get_related_model() — for both async (BaseModel) and async
...
class TestAsyncRelationshipValidator:
    ...
    async def test_belongs_to_has_one_valid(self):
        ...
        class AsyncUser(RelationManagementMixin, BaseModel):
            id: int
            profile: ClassVar[HasOne["AsyncProfile"]] = HasOne(
