...
class TestSyncDescriptorOnAsyncModel:
    ...
    def test_sync_belongs_to_on_async_model_raises(self):
    ...
    def test_sync_has_many_on_async_model_raises(self):
    ...
    def test_sync_has_one_on_async_model_raises(self):
...
class TestAsyncDescriptorOnSyncModel:
    ...
    def test_async_belongs_to_on_sync_model_raises(self):
    ...
    def test_async_has_many_on_sync_model_raises(self):
    ...
    def test_async_has_one_on_sync_model_raises(self):
...
class TestCorrectUsageNoError:
    ...
    def test_sync_descriptor_on_sync_model_ok(self):
    ...
    def test_async_descriptor_on_async_model_ok(self):
